        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DonationAlertsCode = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RawComment = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Payout = table.Column<decimal>(type: "numeric(18,2)", nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedGameRoundId = table.Column<int>(type: "integer", nullable: true),
                    RelatedDonationId = table.Column<int>(type: "integer", nullable: true),
                    RelatedPromocodeId = table.Column<int>(type: "integer", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_Promocodes_RelatedPromocodeId",
                        column: x => x.RelatedPromocodeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_RelatedPromocodeId",
                table: "Transactions",
                column: "RelatedPromocodeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_DonationAlertsCode",
                table: "Users",
                column: "DonationAlertsCode",
                unique: true);
